...
/** Advances and redraws kill-burst particles as motion streaks (a short trail toward
 * where the particle just was, plus a small white-hot spark at its head) rather than a
 * flat square — reads as debris in motion instead of a static dot fading out. Returns
 * the surviving entries. Clears `g` before drawing. */
